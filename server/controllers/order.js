...
exports.create = function(req, res, next){  
    ...
    Cart.findById(cartId).populate('cartItems.$*.productVariation').exec( function(err, cart) {
        ...
        var newOrder = new Order({orderTime: new Date(), status: "pending",  totalPrice: totalPrice, orderItems: items, firstName: firstName, lastName: lastName, email: email, phone: phone, payment: payment, deliveryAddress: deliveryAddress, deliveryType: deliveryType});
